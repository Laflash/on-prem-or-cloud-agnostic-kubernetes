...
kubeadm init --pod-network-cidr=10.244.0.0/16  --apiserver-advertise-address="192.168.1.121" #if you want to use a different IP address than the main server IP
export KUBECONFIG=/etc/kubernetes/admin.conf
